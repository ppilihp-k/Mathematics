...
public class Matrix extends Observable{
	...
	/**
	 * subtracts the specified rows, this method performs a write operation on the actual matrix!
	 * @param i1 the first row
	 * @param i2 the second row, from which the first row is subtracted
	 */
	...
	/**
	 * performs a row swap on this matrix
	 * @param i1 first row
	 * @param i2 second row
	 */
